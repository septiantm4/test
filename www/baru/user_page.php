<?php
session_start();
if(!isset($_SESSION['user_session_tutorial']))
{
  header("Location: index.php");
}
include_once 'dbconfig.php';
$sql = mysql_query("SELECT * FROM tbl_users WHERE user_id='".$_SESSION['user_session_tutorial']."'");
                                        ...
                                        <li class="widget uib_w_24" data-uib="framework7/input" data-ver="0">
                                            <div class="item-content">
                                                <div class="item-inner">
                                                    <div class="item-title label">Nama djsaiohifgisdf</div>
